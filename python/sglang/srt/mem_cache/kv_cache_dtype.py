...
def configure_kv_cache_dtype(
    *,
    ...
    if server_args_kv_cache_dtype == "auto":
        ...
        # Keep the concrete storage dtype aligned with the CLI option.  The
        # v0.5.12_dev HCU branch uses native E5M2 here instead of collapsing
        # fp8_e5m2 to the backend-default fp8_dtype (E4M3FN on gfx936).
