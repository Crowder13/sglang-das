...
def _load_waveform(
    ...
    *,
    ...
    ffmpeg decodes the input directly into the model's canonical audio layout:
    32 kHz, stereo, interleaved float PCM on stdout. That keeps the audio path
    independent of torchaudio and avoids a second resampling step in Python.
    """
